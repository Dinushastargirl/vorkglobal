      ...
      <section className="py-24 bg-charcoal">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              <h2 className="text-3xl font-bold mb-12">Contact <span className="text-zinc-500">Information.</span></h2>
              <div className="space-y-10">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">hello@vork.global</p>
                    <p className="text-zinc-400">support@vork.global</p>
                  </div>
                </div>
                <div className="flex items-start gap-6">
                  <div className="w-14 h-14 rounded-2xl glass flex items-center justify-center shrink-0">
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">Tech City, TC 12345</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass p-10 rounded-[3rem]">
              <form className="space-y-6">
                ...
                <button className="w-full py-5 bg-accent-cyan text-obsidian rounded-2xl font-bold text-lg flex items-center justify-center gap-2 hover:bg-white transition-all">
