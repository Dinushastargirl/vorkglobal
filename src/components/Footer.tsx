...
export const Footer = () => {
  return (
    <footer id="contact" className="pt-24 pb-12 bg-obsidian border-t border-white/5">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-24">
          <div>
            ...
            <motion.a 
              ...
              className="inline-flex items-center gap-4 text-2xl font-bold hover:text-accent-cyan transition-colors group"
            >
              hello@vork.global
          ...
          <div className="grid grid-cols-2 gap-12">
            <div>
              ...
              <ul className="space-y-4 text-zinc-400">
                ...
                <li><Link to="/ai-integration" className="hover:text-white transition-colors">AI Integration</Link></li>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-12 border-t border-white/5 gap-6">
          <Link to="/" className="flex items-center gap-2">
            <div className="w-6 h-6 bg-gradient-to-br from-accent-cyan to-accent-violet rounded flex items-center justify-center font-bold text-obsidian text-xs">
              V
            </div>
            <span className="font-bold tracking-tight">vork.global</span>
          </Link>
